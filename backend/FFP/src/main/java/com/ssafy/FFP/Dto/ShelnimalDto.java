...
public class ShelnimalDto {
	...
	public String toString() {
		return "APIDto [desertionNo=" + desertionNo + ", filename=" + filename + ", happenDt=" + happenDt
	...
	public ShelnimalDto(String desertionNo, String filename, String happenDt, String happenPlace, String kindCd,
