...
//                System.out.println(Arrays.toString(valuearr));
        ...
        // DB에 저장하기
//        int date_rs = analysisDao.I_weight_list(list);
//        int date_rs2 = analysisDao.test();
...
//            long value = (long) now.get(1);
//            if ( value >= 10 ) {
//                AnalysisDto dto = new AnalysisDto(temp,value, "005");
//                list.add(dto);
//                int weight_rs = analysisDao.Insert(dto);
//            }
//        });
