        ...
        <main>
            ...
            <section class="slider-area">
                <div class="slider-active">
                    <div class="single-slider slider-bg d-flex align-items-center" style="background-image: url('img/slider/slider_bg01.jpg')">
                        <div class="container custom-container">
                            <div class="row">
                                <div class="col-xl-5 col-lg-7 col-md-10">
                                    <div class="slider-content" >
                                        <div class="slider-title">
                                            <h2 class="title" data-animation="fadeInUpBig" data-delay=".2s" data-duration="1.2s" >For<span>with</span><br>Four<br>Paw</h2>
                                        </div>
                                        <div class="slider-desc">
                                            <p class="desc" data-animation="fadeInUpBig" data-delay=".4s" data-duration="1.2s" >For Four Paw 에서는 유기동물 및 실종동물을 조회할 수 있습니다.</p>
                                        </div>
                    ...
                    <div class="single-slider slider-bg d-flex align-items-center" style="background-image: url('img/slider/slider_bg02.jpg')">
                        <div class="container custom-container">
                            <div class="row">
                                <div class="col-xl-5 col-lg-7 col-md-10">
                                    <div class="slider-content">
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="breed-services-info" style="background-image: url('img/bg/breed_services_bg.jpg')">
