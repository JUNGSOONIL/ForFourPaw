    ...
    <!-- Preloader -->
        ...
        <header>
            ...
            <div id="sticky-header" class="menu-area">
                                ...
                                <nav class="menu-nav show">
                                    ...
                                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                                        <ul class="navigation">
                                            ...
                                            <li class="menu-item-has-children"> <router-link to="/shop">Shop</router-link>
                                                
                                                <ul class="submenu">
                                                    <li><router-link to="/shop">Our Shop</router-link></li>
                                                    <li><router-link to="/shopDetail">Shop Details</router-link></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="menu-item-has-children"><router-link to="/blog">Blog</router-link>
                                                <ul class="submenu">
                ...
                <div class="header-shape" style="background-image: url('img/bg/header_shape.png')"></div>
            </div>
            <!-- header-search -->
